Ambi.General.CreateModule( 'Base' )
...
-- ----------------------------------------------------------------------------------------------------------------------------------------
Ambi.Base.Config.hud_enable = false -- Включить систему мульти-худов и ограничения для стандартного худа (которые ниже)
...
-- ----------------------------------------------------------------------------------------------------------------------------------------
Ambi.Base.Config.disable_render_on_hasnt_focus = false -- Отключать рендер, когда у игрока запущена игра, но она свернута?