...
CreateClientConVar( 'amb_mm_enable', '1', true )
CreateClientConVar( 'amb_mm_page', '1', true )
...
function AMB.UI.MainMenu.BlockMenu()

    hook.Remove( 'ScoreboardShow', 'AMB.UI.MainMenu.CallMainMenu' )
    hook.Remove( 'ScoreboardHide', 'AMB.UI.MainMenu.HideMainMenu' )
