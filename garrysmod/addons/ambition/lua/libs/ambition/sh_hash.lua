AMB.Ambition.Hash = AMB.Ambition.Hash or {}
...
function AMB.Ambition.Hash.MD5( sStr )
    local msgLen = #sStr
...
local HH = {}
function AMB.Ambition.Hash.SHA256( sMsg )
...
function AMB.Ambition.Hash.PseudoRandom( nSeed )
