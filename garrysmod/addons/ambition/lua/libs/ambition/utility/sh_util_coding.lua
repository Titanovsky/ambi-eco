AMB.Ambition.Utility.Coding = AMB.Ambition.Utility.Coding or {}
util.Coding = util.Coding or {}
setmetatable( AMB.Ambition.Utility.Coding, { __index = util.Coding } )
...
function util.Coding.DecodeURL( sUrl )
    ...
    local str = ''
    str = gsub( sUrl, '+', ' ' )
    str = gsub( str, '%%(%x%x)', AMB.Ambition.Utility.Coding.CharToHEX )
